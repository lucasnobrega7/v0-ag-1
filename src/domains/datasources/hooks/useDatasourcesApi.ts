...
/**
 * Hook para interagir com a API de datasources
 */
export function useDatasourcesApi() {
  ...
  const createDatasource = async (data: DatasourceCreate): Promise<Datasource | null> => {
    ...
    try {
      const result = await datasourceApiService.createDatasource(data)
      return result
    } catch (err) {
  ...
  const getDatasource = async (datasourceId: string): Promise<Datasource | null> => {
    ...
    try {
      const result = await datasourceApiService.getDatasource(datasourceId)
      return result
    } catch (err) {
  ...
  const deleteDatasource = async (datasourceId: string): Promise<boolean> => {
    ...
    try {
      await datasourceApiService.deleteDatasource(datasourceId)
      return true
    } catch (err) {
  ...
  const listDatasources = async (): Promise<Datasource[]> => {
    ...
    try {
      const result = await datasourceApiService.listDatasources()
      return result
    } catch (err) {
